...
import org.apache.pig.backend.hadoop.executionengine.mapReduceLayer.bytecode.PhysicalPlanToByteCode;
...
public abstract class PigGenericMapBase extends Mapper<Text, Tuple, PigNullableWritable, Writable> {
    ...
    public void setup(Context context) throws IOException, InterruptedException {
        ...
        if(!(mp.isEmpty())) {
            ...
            PhysicalPlanToByteCode compiler = new PhysicalPlanToByteCode();
            mp = compiler.compile(mp, targetOpKeys);
